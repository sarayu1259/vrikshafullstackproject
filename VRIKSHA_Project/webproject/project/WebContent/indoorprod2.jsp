...
<nav>
      ...
      <a href="home.jsp">Home</a> &gt; 
        <a href="indoorplants.jsp">Outdoor Plants</a> &gt; 
        <a href="indoorprod1.jsp">Lucky Bamboo Plant</a> &gt; 
    </nav>
    <main>
        <section class="product-details">
            <div class="images-column">
                <div class="image-container">
                    <img id="main-img" class="main-img" src="https://www.ugaoo.com/cdn/shop/products/DSC_9031-Copy_3.jpg?v=1696240355" alt="Mums Gratitude">
                </div>
                <div class="thumbnails">
                    <img id="thumbnail1" src="https://www.ugaoo.com/cdn/shop/products/DSC_9031-Copy_3.jpg?v=1696240355" alt="Thumbnail 1" data-src="https://assets.winni.in/product/primary/2023/6/85354.jpeg?dpr=1&w=400">
                    <img id="thumbnail2" src="ttps://www.ugaoo.com/cdn/shop/files/BambooPalm_3ba11aff-5270-4703-ab8e-549eecc204f9.jpg?v=1710162438" alt="Thumbnail 2" data-src="https://assets.winni.in/product/primary/2022/9/74949.jpeg?dpr=1&w=400">
                                    </div>
            </div>
            <div class="details-column" style="padding-left:20px">
                <h1>Lucky Bamboo Plant</h1>
                ...
                <form onsubmit="return validatePincode()">
                 ...
                 <div class="buttons">
                    <form action="AddToWishlistServlet" method="post">
                        ...
                        <input type="hidden" name="item" value="Bamboo Palm Plant">
                        <input type="hidden" name="price" value="599">
                        <input type="hidden" name="imageUrl" value="https://www.ugaoo.com/cdn/shop/products/GroPot_cff1f8cf-e233-4cbf-9cfa-8ef815e851dd.jpg?v=1696240355">
    ...
    <input type="hidden" name="imageUrl" value="https://www.ugaoo.com/cdn/shop/products/GroPot_cff1f8cf-e233-4cbf-9cfa-8ef815e851dd.jpg?v=1696240355"> <!-- Provide the image URL here -->
    <button type="submit"
        ...
        <section class="product-description">
            ...
            <ul>
               <li> Plant Name- Bamboo Palm Plant</li>
                <li>Plant Type- Indoor Plant</li>
                <li>Plant Placement- Indoors</li>
