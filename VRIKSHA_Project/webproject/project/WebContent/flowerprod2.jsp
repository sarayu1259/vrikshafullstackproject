...
<nav>
      ...
      <a href="home.jsp">Home</a> &gt; 
        <a href="outdoorplants.jsp">FLowering Plants</a> &gt; 
        <a href="outprod1.jsp">African Violet</a> &gt; 
    </nav>
    <main>
        <section class="product-details">
            <div class="images-column">
                <div class="image-container">
                    <img id="main-img" class="main-img" src="https://bloomboxclub.com/cdn/shop/articles/African_Violet_-_Speciality_Care_And_Growing_Guide_1200x1200.jpg?v=1693913603" alt="chrysanthemum">
                </div>
                <div class="thumbnails">
                    <img id="thumbnail1" src="https://www.marthastewart.com/thmb/3Z-YRa8GwLFptXnfdtIm3_2Ka50=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/flowering-indoor-plants-lovely-blooms-african-violet-getty-0523-9e3e6df1f69c4c4992ed15726369be95.jpg" alt="Thumbnail 1" data-src="https://assets.winni.in/product/primary/2023/6/85354.jpeg?dpr=1&w=400">
                    <img id="thumbnail2" src="https://bloomboxclub.com/cdn/shop/articles/African_Violet_-_Speciality_Care_And_Growing_Guide_1200x1200.jpg?v=1693913603" alt="Thumbnail 2" data-src="https://assets.winni.in/product/primary/2022/9/74949.jpeg?dpr=1&w=400">
                                    </div>
            </div>
            <div class="details-column" style="padding-left:20px">
                <h1>African_Violet</h1>
                <p class="price">Rs 310  <span> <del>Rs 219 </del> Inclusive of all taxes</span></p>
                <div class="rating">
              ...
              <span>(4.5/5)</span>
                ...
                <div class="buttons">
                    <form action="AddToWishlistServlet" method="post">
                        ...
                        <input type="hidden" name="item" value="African_Violet">
                        <input type="hidden" name="price" value="599">
                        <input type="hidden" name="imageUrl" value="https://assets.winni.in/product/primary/2023/6/85354.jpeg?dpr=1&w=400">
    ...
    <input type="hidden" name="imageUrl" value="https://assets.winni.in/product/primary/2023/6/85354.jpeg?dpr=1&w=400"> <!-- Provide the image URL here -->
    <button type="submit"
        ...
        <section class="product-description">
            ...
            <ul>
               <li> Plant Name- African-Violet Plant (Violet)</li>
                <li>Plant Type- Flowering Plant</li>
