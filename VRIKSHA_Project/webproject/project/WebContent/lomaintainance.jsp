    ...
    <nav>
      ...
      <nav class="navigation">
       ...
       <a href="home.jsp">Home</a> &gt; 
        <a href="lomaintainance.jsp">Low Maintainance Plants</a> &gt; 
        
    </nav>
    <div>
      <img src="https://www.chhajedgarden.com/cdn/shop/articles/Low_maintenance_indoor_plants_cover_1200x600_crop_center.jpg?v=1666724924" style="width: 100%; height: 400px; object-fit: cover;">
    </div>
  <div>
    <div class="indoor-text">
      <h1 class="outdoor-description" >Low Maintenance Plants</h1>
      <p class="outdoor-text">Low maintenance plants offer effortless beauty and resilience, perfect for busy individuals. These hardy varieties require minimal care, thriving in various conditions while adding greenery and charm to any space.</p>
  </div>
  ...
  <div class="product-grid">
      <div class="product-card">
        <div class="product-image">
          ...
          <a href=""><img src="https://assets.winni.in/product/primary/2023/3/83795.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
          
        </div>
        <div class="product-info">
          <h2>Elegant Syngonium Plant</h2>
          <div class="rating">
      ...
      <div class="product-card">
        <div class="product-image">
         <a href=""> <img src="https://assets.winni.in/product/primary/2023/6/85454.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Jute Wrapped Money Plant</h2>
          <div class="rating">
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
      ...
      <div class="product-card">
        <div class="product-image">
         <a href=""> <img src="https://assets.winni.in/product/primary/2014/8/43194.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Golden Syngonium In Black Buddha Pot</h2>
          <div class="rating">
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star-half" aria-hidden="true"></i>
      ...
      <div class="product-card">
        <div class="product-image">
         <a href=""> <img src="https://assets.winni.in/product/primary/2014/10/50378.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Double Layered Lucky Bamboo Plant</h2>
          <div class="rating">
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
      ...
      <div class="product-card">
        <div class="product-image">
          <a href=""><img src="https://assets.winni.in/product/primary/2022/11/79539.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
      ...
      <div class="product-card">
        <div class="product-image">
          <a href=""><img src="https://assets.winni.in/product/primary/2014/6/33474.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
      ...
      <div class="product-card">
        <div class="product-image">
        <a href="" > <img src="https://assets.winni.in/product/primary/2022/6/61486.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Natural Combo Of Live Indoor Plants For Home</h2>
          <div class="rating">
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
      ...
      <div class="product-card">
        <div class="product-image">
        <a href=""> <img src="https://assets.winni.in/product/primary/2023/3/83811.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Exotic Sanseviera Plant</h2>
          <div class="rating">
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
      ...
      <div class="product-card">
        <div class="product-image">
         <a href=""> <img src="https://assets.winni.in/product/primary/2023/5/84733.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>

        </div>
        <div class="product-info">
          <h2>Lovabl Jade Plant</h2>
          <div class="rating">
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
      ...
      <div class="product-card">
        <div class="product-image">
         <a href=""> <img src="https://assets.winni.in/product/primary/2023/6/85703.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Pothos Plant In Red Pot
          </h2>
          <div class="rating">
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
      ...
      <div class="product-card">
        <div class="product-image">
        <a href=""> <img src="https://assets.winni.in/product/primary/2023/5/85021.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
      <div class="product-info">
          <h2>Lush Green 2 Layered Bamboo Plant</h2>
          <div class="rating">
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
      ...
      <div class="product-card">
        <div class="product-image">
          <a href=""><img src="https://assets.winni.in/product/primary/2023/6/85452.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Peace Lily</h2>
          <div class="rating">
