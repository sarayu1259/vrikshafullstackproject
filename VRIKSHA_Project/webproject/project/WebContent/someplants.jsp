  ...
  <div class="product-grid">
      <div class="product-card">
        <div class="product-image">
          ...
          <a href="index1.html"><img src="https://assets.winni.in/product/primary/2023/6/85448.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
          
        </div>
        <div class="product-info">
          <h2>Pleasing Peace Lily</h2>
          <div class="rating">
      ...
      <div class="product-card">
        <div class="product-image">
         <a href="index2.html"> <img src="https://assets.winni.in/product/primary/2024/3/94483.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Vibrant Money Plant</h2>
          <div class="rating">
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
      ...
      <div class="product-card">
        <div class="product-image">
         <a href="index3.html"> <img src="https://assets.winni.in/product/primary/2023/6/85454.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
      ...
      <div class="product-card">
        <div class="product-image">
         <a href="index4.html"> <img src="https://assets.winni.in/product/primary/2023/3/83821.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Pretty ZezePlant</h2>
          <div class="rating">
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
      ...
      <div class="product-card">
        <div class="product-image">
          <a href="index5.html"><img src="https://assets.winni.in/product/primary/2022/11/79561.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
      ...
      <div class="product-card">
        <div class="product-image">
          <a href="index6.html"><img src="https://assets.winni.in/product/primary/2014/10/47134.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Remarkable Red Roses</h2>
          <div class="rating">
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
      ...
      <div class="product-card">
        <div class="product-image">
        <a href="index8.html"> <img src="https://assets.winni.in/product/primary/2023/5/84733.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>White Potted Table Kamini</h2>
          <div class="rating">
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
