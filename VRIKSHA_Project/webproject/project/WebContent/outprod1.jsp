...
<nav>
      ...
      <a href="home.jsp">Home</a> &gt; 
        <a href="outdoorplants.jsp">Outdoor Plants</a> &gt; 
        <a href="outprod1.jsp">Mums Gratitude</a> &gt; 
    </nav>
    <main>
        <section class="product-details">
            <div class="images-column">
                <div class="image-container">
                    <img id="main-img" class="main-img" src="https://assets.winni.in/product/primary/2014/10/48673.jpeg?dpr=1&w=400" alt="Mums Gratitude">
                </div>
                <div class="thumbnails">
                    <img id="thumbnail1" src="https://assets.winni.in/product/primary/2014/10/48673.jpeg?dpr=1&w=400" alt="Thumbnail 1" data-src="https://assets.winni.in/product/primary/2023/6/85354.jpeg?dpr=1&w=400">
                    <img id="thumbnail2" src="https://assets.winni.in/product/primary/2014/10/48674.jpeg?dpr=1&w=400" alt="Thumbnail 2" data-src="https://assets.winni.in/product/primary/2022/9/74949.jpeg?dpr=1&w=400">
                                    </div>
            </div>
            <div class="details-column" style="padding-left:20px">
                <h1>Mums Gratitude</h1>
                <p class="price">Rs 260  <span> <del>Rs 310 </del> Inclusive of all taxes</span></p>
                <div class="rating">
              ...
              <span>(4.5/5)</span>
                ...
                <div class="buttons">
                    <form action="AddToWishlistServlet" method="post">
                        ...
                        <input type="hidden" name="item" value="Mums Gratitude">
                        <input type="hidden" name="price" value="260">
                        <input type="hidden" name="imageUrl" value="https://assets.winni.in/product/primary/2014/10/48673.jpeg?dpr=1&w=400">
    ...
    <input type="hidden" name="item" value="Mums Gratitude">
    <input type="hidden" name="price" value="260">
    <input type="hidden" name="imageUrl" value="https://assets.winni.in/product/primary/2014/10/48673.jpeg?dpr=1&w=400"> <!-- Provide the image URL here -->
    <button type="submit"
        ...
        <section class="product-description">
            ...
            <ul>
               <li> Plant Name- Rose Plant (Red)</li>
