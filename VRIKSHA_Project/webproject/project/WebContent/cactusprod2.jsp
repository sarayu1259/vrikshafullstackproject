...
<nav>
      ...
      <a href="home.jsp">Home</a> &gt; 
        <a href="cactus.jsp">Cactus Plants</a> &gt; 
        <a href="cactusprod2.jsp">Twin Spined Cactus</a> &gt; 
    </nav>
    <main>
        <section class="product-details">
            <div class="images-column">
                <div class="image-container">
                    <img id="main-img" class="main-img" src="https://media.greg.app/Y2FyZS1wbGFudC1wcm9maWxlL3VzZXJzLzMzNDEvcGxhbnQtcGhvdG9zLzIyMTY0MDYvMTcwMzI3NTk5OTQ0MC1DNTA0NDRDOC1GNjM3LTRENTktQTg0RC05MDA0OEJDNzBBQzIucG5n?auto=webp&width=770&fit=cover&format=pjpg&height=620&optimize=medium&precrop=770:620,smart" alt="Mums Gratitude">
                </div>
                <div class="thumbnails">
                    <img id="thumbnail1" src="https://www.gertens.com/media/catalog/product/cache/552aa5ee50ba4e27dfcb5fa3e4dca5ac/g/o/golden-barrel-cactus-6in_1.jpg" alt="Thumbnail 1" data-src="https://media.greg.app/Y2FyZS1wbGFudC1wcm9maWxlL3VzZXJzLzMzNDEvcGxhbnQtcGhvdG9zLzIyMTY0MDYvMTcwMzI3NTk5OTQ0MC1DNTA0NDRDOC1GNjM3LTRENTktQTg0RC05MDA0OEJDNzBBQzIucG5n?auto=webp&width=770&fit=cover&format=pjpg&height=620&optimize=medium&precrop=770:620,smart">
                                    </div>
            </div>
            <div class="details-column" style="padding-left:20px">
                <h1>Twin Spined Cactus</h1>
                <p class="price">Rs 219  <span> <del>Rs 310 </del> Inclusive of all taxes</span></p>
                <div class="rating">
                ...
                <form onsubmit="return validatePincode()">
                 ...
                 <div class="buttons">
                    <form action="AddToWishlistServlet" method="post">
                        ...
                        <input type="hidden" name="item" value="Twin Spined Cactus">
                        <input type="hidden" name="price" value="599">
                        <input type="hidden" name="imageUrl" value="https://media.greg.app/Y2FyZS1wbGFudC1wcm9maWxlL3VzZXJzLzMzNDEvcGxhbnQtcGhvdG9zLzIyMTY0MDYvMTcwMzI3NTk5OTQ0MC1DNTA0NDRDOC1GNjM3LTRENTktQTg0RC05MDA0OEJDNzBBQzIucG5n?auto=webp&width=770&fit=cover&format=pjpg&height=620&optimize=medium&precrop=770:620,smart">
    ...
    <input type="hidden" name="imageUrl" value="https://media.greg.app/Y2FyZS1wbGFudC1wcm9maWxlL3VzZXJzLzMzNDEvcGxhbnQtcGhvdG9zLzIyMTY0MDYvMTcwMzI3NTk5OTQ0MC1DNTA0NDRDOC1GNjM3LTRENTktQTg0RC05MDA0OEJDNzBBQzIucG5n?auto=webp&width=770&fit=cover&format=pjpg&height=620&optimize=medium&precrop=770:620,smart"> <!-- Provide the image URL here -->
    <button type="submit"
        ...
        <section class="product-description">
            ...
            <h3>Product Details:</h3>
             <ul>
                <li>Plant Name- Barrel Cactus/li>
                <li>Plant Type- Cactus Plant</li>
                <li>Plant Placement- Outdoors</li>
                <li>Plant Height- Upto 12 inches</li>
                <li>Medium Size Ceramic Pot</li>
                <li>Winni Message Card</li>
            </ul>
