...
<body>
    ...
    <div>
      <img src="https://1.bp.blogspot.com/-ZaSsNkdmqt8/V0IxAL5XsrI/AAAAAAAAJK4/TJvqR24WKtAv8nnrFZyftc7_7NQRNSDqQCLcB/s0/flowers-1192921-2880-1800.jpg" style="width: 100%; height: 400px; object-fit: cover;">
    </div>
  <div>
    <div class="indoor-text">
      <h1 class="outdoor-description" >Flowering Plants</h1>
      <p class="outdoor-text">Flowering plants, also known as angiosperms, are the most diverse group of land plants.
      Flowering plants add beauty and biodiversity to
       gardens and natural landscapes. They are not only aesthetically pleasing but also essential for maintaining ecological balance and supporting various life forms.</p>
  </div>
  ...
  <div class="product-grid">
      <div class="product-card">
        <div class="product-image">
          ...
          <a href="flowerprod1.jsp"><img src="https://media.diy.com/is/image/Kingfisher/chrysanthemum-pot~3663602463788_02c_bq?$MOB_PREV$&$width=618&$height=618" alt="Peace Lily Plant"></a>
        ...
        <div class="product-info">
          ...
          <a href="flowerprod1.jsp"><button class="view-product">View Product</button></a>
          <div class="cart">
      ...
      <div class="product-card">
        <div class="product-image">
         <a href="flowerprod2.jsp"> <img src="https://bloomboxclub.com/cdn/shop/articles/African_Violet_-_Speciality_Care_And_Growing_Guide_1200x1200.jpg?v=1693913603" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          ...
          <a href="flowerprod2.jsp"><button class="view-product">View Product</button></a>
        </div>
      </div>
      <div class="product-card">
        <div class="product-image">
         <a href=""> <img src="https://www.marthastewart.com/thmb/RRCESkEeUYtc2XAexSu1tBEn52s=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/flowering-indoor-plants-lovely-blooms-clivia-getty-0523-c618a589774744a7b56338b50562f28a.jpg" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Clivias</h2>
          <div class="rating">
      ...
      <div class="product-card">
        <div class="product-image">
         <a href=""> <img src="https://www.marthastewart.com/thmb/UDceeANvs1WVCD7ixXfm172JEMo=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/flowering-indoor-plants-lovely-blooms-roses-getty-0523-56334f6615414aeaa8161a1e1c46cd43.jpg" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Roses</h2>
          <div class="rating">
      ...
      <div class="product-card">
        <div class="product-image">
          <a href=""><img src="https://www.bobvila.com/wp-content/uploads/2019/03/Begonia-flowering-houseplants.jpg" alt="Peace Lily Plant"></a>
      ...
      <div class="product-card">
        <div class="product-image">
          <a href="index6.html"><img src="https://www.bobvila.com/wp-content/uploads/2019/03/False_Shamrock-flowering-houseplants.jpg" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
      ...
      <div class="product-card">
        <div class="product-image">
        <a href="" > <img src="https://www.bobvila.com/wp-content/uploads/2019/03/Kalanchoe-flowering-houseplants.jpg" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Kalanchoe</h2>
          <div class="rating">
      ...
      <div class="product-card">
        <div class="product-image">
        <a href=""> <img src="https://gardenerspath.com/wp-content/uploads/2022/05/Jasmine-Growing-in-a-Container-Indoors.jpg" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Jasmine</h2>
          <div class="rating">
      ...
      <div class="product-card">
        <div class="product-image">
         <a href=""> <img src="https://www.marthastewart.com/thmb/A4psW-4TsZWzRgZJk1SQcneOHho=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/sculptural-houseplants-sensation-peace-lily-getty-0220-c0b63d72d9004155a180319cac659af0.jpg" alt="Peace Lily Plant"></a>
      ...
      <div class="product-card">
        <div class="product-image">
         <a href=""> <img src="https://www.bobvila.com/wp-content/uploads/2019/03/Christmas_Cactus-flowering-houseplants.jpg" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Christmas_Cactus
          </h2>
      ...
      <div class="product-card">
        <div class="product-image">
        <a href=""> <img src="https://www.bobvila.com/wp-content/uploads/2019/03/Gloxinia-flowering-houseplants.jpg" alt="Peace Lily Plant"></a>
        </div>
      <div class="product-info">
          <h2>Gloxinia</h2>
          <div class="rating">
      ...
      <div class="product-card">
        <div class="product-image">
          <a href=""><img src="https://www.bobvila.com/wp-content/uploads/2019/03/Ixora-flowering-houseplants.jpg" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Ixora</h2>
          <div class="rating">
