...
<nav>
      ...
      <a href="home.jsp">Home</a> &gt; 
        ...
        <a href="outprod1.jsp">Chrysanthemum</a> &gt; 
    </nav>
    <main>
        <section class="product-details">
            <div class="images-column">
                <div class="image-container">
                    <img id="main-img" class="main-img" src="https://media.diy.com/is/image/Kingfisher/chrysanthemum-pot~3663602463788_02c_bq?$MOB_PREV$&$width=618&$height=618" alt="chrysanthemum">
                </div>
                <div class="thumbnails">
                    <img id="thumbnail1" src="https://media.diy.com/is/image/Kingfisher/chrysanthemum-pot~3663602463788_02c_bq?$MOB_PREV$&$width=618&$height=618" alt="Thumbnail 1" data-src="https://assets.winni.in/product/primary/2023/6/85354.jpeg?dpr=1&w=400">
                    <img id="thumbnail2" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgb-mVuuiXFlIP03927_cjB-GN_VqmBU8x1g&s" alt="Thumbnail 2" data-src="https://assets.winni.in/product/primary/2022/9/74949.jpeg?dpr=1&w=400">
                                    </div>
            </div>
              ...
              <span>(4.5/5)</span>
                ...
                <div class="buttons">
                    <form action="AddToWishlistServlet" method="post">
                        ...
                        <input type="hidden" name="item" value="Chrysanthemum">
                        <input type="hidden" name="price" value="599">
                        <input type="hidden" name="imageUrl" value="https://media.diy.com/is/image/Kingfisher/chrysanthemum-pot~3663602463788_02c_bq?$MOB_PREV$&$width=618&$height=618">
    ...
    <input type="hidden" name="imageUrl" value="https://media.diy.com/is/image/Kingfisher/chrysanthemum-pot~3663602463788_02c_bq?$MOB_PREV$&$width=618&$height=618"> <!-- Provide the image URL here -->
    <button type="submit"
        ...
        <section class="product-description">
            ...
            <ul>
               <li> Plant Name-Chrysanthemum  Plant (White)</li>
