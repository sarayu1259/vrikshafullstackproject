...
<nav>
      ...
      <a href="home.jsp">Home</a> &gt; 
        ...
        <a href="cactusprod1.jsp">Barrel Cactus</a> &gt; 
    </nav>
    <main>
        <section class="product-details">
            <div class="images-column">
                <div class="image-container">
                    <img id="main-img" class="main-img" src="https://www.gertens.com/media/catalog/product/cache/552aa5ee50ba4e27dfcb5fa3e4dca5ac/g/o/golden-barrel-cactus-6in_1.jpg" alt="Mums Gratitude">
                </div>
                <div class="thumbnails">
                    <img id="thumbnail1" src="https://www.gertens.com/media/catalog/product/cache/552aa5ee50ba4e27dfcb5fa3e4dca5ac/g/o/golden-barrel-cactus-6in_1.jpg" alt="Thumbnail 1" data-src="https://assets.winni.in/product/primary/2023/6/85354.jpeg?dpr=1&w=400">
                                    </div>
            </div>
                ...
                <form onsubmit="return validatePincode()">
                 ...
                 <div class="buttons">
                    <form action="AddToWishlistServlet" method="post">
                        ...
                        <input type="hidden" name="item" value="Barrel Plant">
                        <input type="hidden" name="price" value="599">
                        <input type="hidden" name="imageUrl" value="https://www.gertens.com/media/catalog/product/cache/552aa5ee50ba4e27dfcb5fa3e4dca5ac/g/o/golden-barrel-cactus-6in_1.jpg">
    ...
    <input type="hidden" name="imageUrl" value="https://www.gertens.com/media/catalog/product/cache/552aa5ee50ba4e27dfcb5fa3e4dca5ac/g/o/golden-barrel-cactus-6in_1.jpg"> <!-- Provide the image URL here -->
    <button type="submit"
