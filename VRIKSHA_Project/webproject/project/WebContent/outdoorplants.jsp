...
<body>
    ...
    <div>
      <img src="images/WhatsApp Image 2024-06-28 at 11.41.55_e86caac1.jpg" style="width: 100%; height: 400px; object-fit: cover;">
    </div>
  <div>
  ...
  <div class="product-grid">
      <div class="product-card">
        <div class="product-image">
          ...
          <a href="outprod1.jsp"><img src="https://assets.winni.in/product/primary/2014/10/48673.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
          
        </div>
        <div class="product-info">
          <h2>Moms Gratitude</h2>
          <div class="rating">
          ...
          <a href="outprod1.jsp"><button class="view-product">View Product</button></a>
          <div class="cart">
      ...
      <div class="product-card">
        <div class="product-image">
         <a href="outprod2.jsp"> <img src="https://assets.winni.in/product/primary/2014/6/33474.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
         ...
         <a href="outprod2.jsp"> <button class="view-product">View Product</button></a>
        </div>
      </div>
      <div class="product-card">
        <div class="product-image">
         <a href="index3.html"> <img src="https://assets.winni.in/product/primary/2022/9/74295.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
      ...
      <div class="product-card">
        <div class="product-image">
         <a href="index4.html"> <img src="https://assets.winni.in/product/primary/2022/11/79539.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Areca Palm Plantt</h2>
          <div class="rating">
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
      ...
      <div class="product-card">
        <div class="product-image">
          <a href="index5.html"><img src="https://assets.winni.in/product/primary/2022/9/74164.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
          
        </div>
        <div class="product-info">
          <h2>Bring Good Luck Plants Triot</h2>
          <div class="rating">
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
      ...
      <div class="product-card">
        <div class="product-image">
          <a href="index6.html"><img src="https://assets.winni.in/product/primary/2022/11/79561.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Snake Plant</h2>
          <div class="rating">
      ...
      <div class="product-card">
        <div class="product-image">
        <a href="index7.html" > <img src="https://assets.winni.in/product/primary/2023/3/83818.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
      ...
      <div class="product-card">
        <div class="product-image">
        <a href="index8.html"> <img src="https://assets.winni.in/product/primary/2022/9/74208.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
          <h2>Feel Blessed Plant Combo Gift</h2>
          <div class="rating">
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
            <i class="fa fa-star" aria-hidden="true"></i>
      ...
      <div class="product-card">
        <div class="product-image">
         <a href="outprod9.html"> <img src="https://assets.winni.in/product/primary/2023/5/84738.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
      ...
      <div class="product-card">
        <div class="product-image">
         <a href="outprod10.html"> <img src="https://assets.winni.in/product/primary/2014/8/43361.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
      ...
      <div class="product-card">
        <div class="product-image">
        <a href="outprod11.html"> <img src="https://assets.winni.in/product/primary/2014/8/43363.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
      <div class="product-info">
      ...
      <div class="product-card">
        <div class="product-image">
          <a href="outprod12.html"><img src="https://assets.winni.in/product/primary/2014/8/43124.jpeg?dpr=1&w=400" alt="Peace Lily Plant"></a>
        </div>
        <div class="product-info">
