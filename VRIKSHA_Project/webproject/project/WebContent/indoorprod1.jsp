...
<nav>
        ...
        <section class="product-details">
            <div class="images-column">
                <div class="image-container">
                    <img id="main-img" class="main-img" src="https://www.ugaoo.com/cdn/shop/products/GroPot.jpg?v=1704867612" alt="Mums Gratitude">
                </div>
                <div class="thumbnails">
                    <img id="thumbnail1" src="https://www.ugaoo.com/cdn/shop/files/peace-lily-plant-32515294756996.jpg?v=1704867612" alt="Thumbnail 1" data-src="https://assets.winni.in/product/primary/2023/6/85354.jpeg?dpr=1&w=400">
                    <img id="thumbnail2" src="https://www.ugaoo.com/cdn/shop/products/DSC_9124_cfe94c59-66ce-45c0-93b1-e1049ad834a1.jpg?v=1704867612" alt="Thumbnail 2" data-src="https://assets.winni.in/product/primary/2022/9/74949.jpeg?dpr=1&w=400">
                                    </div>
            </div>
              ...
              <span>(4.5/5)</span>
                ...
                <div class="buttons">
                    <form action="AddToWishlistServlet" method="post">
                        ...
                        <input type="hidden" name="item" value="Peace Lily Plant">
                        <input type="hidden" name="price" value="219">
                        <input type="hidden" name="imageUrl" value="https://www.ugaoo.com/cdn/shop/products/GroPot.jpg?v=1704867612">
    ...
    <input type="hidden" name="item" value="Peace Lily Plant">
    <input type="hidden" name="price" value="219">
    <input type="hidden" name="imageUrl" value="https://www.ugaoo.com/cdn/shop/products/GroPot.jpg?v=1704867612"> <!-- Provide the image URL here -->
    <button type="submit"
        ...
        <section class="product-description">
            ...
            <ul>
               <li> Plant Name- Peace Lily Plant)</li>
